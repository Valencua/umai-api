...
ERROR_CODES_CONFLICTO = (ERROR_CODE_TURNO_LLENO, ERROR_CODE_RESERVA_TURNO_PASADO, ERROR_CODE_RESERVA_ACTIVA, ERROR_CODE_RESERVA_CANCELADA, ERROR_CODE_PLATO_DUPLICADO, ERROR_CODE_RESERVA_YA_CONFIRMADA,)
